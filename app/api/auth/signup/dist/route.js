...
var cookies_1 = require("@/lib/cookies"); // ✅ use attach helper
var db_1 = require("@/config/db");
function POST(req) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function () {
        var _c, name, email, password, normalizedEmail, existing, passwordHash, user, jti, session, refresh, res;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, req.json()];
                case 1:
                    _c = _d.sent(), name = _c.name, email = _c.email, password = _c.password;
                ...
                case 7:
                    // Persist refresh (hashed)
                    _d.sent();
                    res = server_1.NextResponse.json({ user: user }, { status: 201, headers: { "Cache-Control": "no-store" } });
