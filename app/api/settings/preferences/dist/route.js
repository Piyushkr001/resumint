        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, db_1.db.query.userPreferencesTable.findFirst({
                            where: drizzle_orm_1.eq(schema_1.userPreferencesTable.userId, uid)
                        })];
                case 2:
                    row = _e.sent();
                    return [2 /*return*/, json({
                            theme: (_a = row === null || row === void 0 ? void 0 : row.theme) !== null && _a !== void 0 ? _a : "system",
                            locale: (_b = row === null || row === void 0 ? void 0 : row.locale) !== null && _b !== void 0 ? _b : "en",
                            density: (_c = row === null || row === void 0 ? void 0 : row.density) !== null && _c !== void 0 ? _c : "comfortable"
                        })];
                case 3:
                    e_1 = _e.sent();
                    console.error("settings/preferences GET error:", e_1);
...
function POST(req) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        var uid, raw, parsed, _b, theme, locale, density, now, e_2;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 4, , 5]);
                ...
                case 2:
                    ...
                    parsed = PrefBody.safeParse(raw);
                    if (!parsed.success) {
                        return [2 /*return*/, json({ error: parsed.error.flatten() }, 400)];
                    }
                    _b = parsed.data, theme = _b.theme, locale = _b.locale, density = _b.density;
                    now = new Date();
                    return [4 /*yield*/, db_1.db
                            .insert(schema_1.userPreferencesTable)
                            .values({ userId: uid, theme: theme, locale: locale, density: density, updatedAt: now })
                            .onConflictDoUpdate({
                            target: schema_1.userPreferencesTable.userId,
                            set: { theme: theme, locale: locale, density: density, updatedAt: now }
                        })];
                case 3:
                    _c.sent();
                ...
                case 4:
                    e_2 = _c.sent();
                    console.error("settings/preferences POST error:", e_2);
