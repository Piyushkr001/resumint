...
var DeleteBody = zod_1.z.object({
    confirm: zod_1.z.literal(true)
});
// POST /api/settings/delete-account
function POST(req) {
    return __awaiter(this, void 0, void 0, function () {
        var uid, bodyUnknown, parsed, user, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    parsed = DeleteBody.safeParse(bodyUnknown);
                    if (!parsed.success) {
                        return [2 /*return*/, json({ error: "Confirmation required" }, 400)];
                    }
                ...
                case 3:
                    ...
                    return [4 /*yield*/, db_1.db["delete"](schema_1.usersTable).where(drizzle_orm_1.eq(schema_1.usersTable.id, uid))];
                case 4:
                    _a.sent();
                    res = json({ ok: true });
