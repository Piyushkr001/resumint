...
var react_visually_hidden_1 = require("@radix-ui/react-visually-hidden"); // ✅ add this
var NAV = [
    ...
    return (React.createElement(tooltip_1.TooltipProvider, { delayDuration: 0 },
        React.createElement("div", { className: "flex h-full w-full flex-col" },
            React.createElement("div", { className: utils_1.cn("flex items-center gap-2 px-3 py-3", collapsed ? "justify-center" : "justify-start") },
                React.createElement("div", { className: "h-9 w-9 rounded-lg bg-primary/10 grid place-items-center" },
                    React.createElement(lucide_react_1.Sparkles, { className: "h-4 w-4 text-primary" })),
                !collapsed && (React.createElement("div", { className: "font-semibold tracking-tight" }, "Resumint"))),
            ...
            React.createElement(scroll_area_1.ScrollArea, { className: "flex-1" },
                React.createElement("nav", { className: "px-2 py-2", "aria-label": "Dashboard" }, NAV.map(function (item) {
                    var Icon = item.icon;
                    var active = pathname === item.href || (pathname === null || pathname === void 0 ? void 0 : pathname.startsWith(item.href + "/"));
