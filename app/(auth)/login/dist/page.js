...
function LoginPage() {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        promise = axios_1["default"].post("/api/auth/login", { email: values.email, password: values.password }, { withCredentials: true });
                        return [4 /*yield*/, react_hot_toast_1["default"].promise(promise, {
                                loading: "Signing you in…",
                                success: "Welcome back!",
                                error: function (err) { var _a, _b; return ((_b = (_a = err === null || err === void 0 ? void 0 : err.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.error) || (err === null || err === void 0 ? void 0 : err.message) || "Login failed. Please try again."; }
                            })];
                    case 2:
                        _c.sent();
    ...
    return (React.createElement("main", { className: "grid min-h-svh grid-cols-1 bg-background text-foreground lg:grid-cols-2" },
                            ...
                            React.createElement("div", { className: "flex items-center justify-between gap-3" },
                                React.createElement("label", { htmlFor: "remember", className: "flex items-center gap-2 text-sm" },
                                    React.createElement(checkbox_1.Checkbox, { id: "remember", checked: form.watch("remember"), onCheckedChange: function (v) {
                                            return form.setValue("remember", Boolean(v), { shouldDirty: true });
                                        }, disabled: loading }),
        ...
        React.createElement("div", { className: "relative hidden overflow-hidden border-l border-border bg-muted/30 lg:block" },
            React.createElement("div", { className: "pointer-events-none absolute left-1/2 top-24 -z-10 h-72 w-72 -translate-x-1/2 rounded-full blur-3xl", style: {
