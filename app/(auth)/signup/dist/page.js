...
var SignupClient_1 = require("./SignupClient");
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    _c.sent();
                    navigation_1.redirect("/dashboard?already=1");
                    return [3 /*break*/, 5];
                case 4:
                    _b = _c.sent();
                    return [3 /*break*/, 5];
                case 5: return [2 /*return*/, React.createElement(SignupClient_1["default"], null)];
            }
        });
    });
}
